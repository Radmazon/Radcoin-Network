...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".radcoin")
}
...
func New(
	...
	app.UpgradeKeeper = upgradekeeper.NewKeeper(
		...
		appCodec,
		filepath.Join(cast.ToString(appOpts.Get(flags.FlagHome)), "data"),
		app.BaseApp,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	)
	...
	// At this point, the global config should be sealed
	sdk.GetConfig().Seal()
...
// SimulationManager returns the SimulationManager
// Note: This method is a stub to satisfy interface requirements
func (app *App) SimulationManager() *module.SimulationManager {
	// Return a basic simulation manager for testing purposes
	return module.NewSimulationManagerFromAppModules(app.ModuleManager.Modules, nil)
}
...
func (app *App) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) {
	// Implementation for zero height genesis prep
}

func (app *App) setupUpgradeStoreLoaders() {
	upgradeInfo, err := app.UpgradeKeeper.ReadUpgradeInfoFromDisk()
	if err != nil {
		// No upgrade info found, continue
		return
	}
...
func (app *App) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
	...
	// RPC routes registration (removed deprecated rpc.RegisterRoutes)
...
func RegisterSwaggerAPI(rtr *mux.Router) {
	// Simple swagger registration without statik
}
